defmodule ExSyncLib.ProjectAnalyzer.SrcDirs do
  def run(mixfile_path, build_path) do
    ...
    # This is necessary not because we're actually building anything, but to
    # ensure that we're watching the correct paths
